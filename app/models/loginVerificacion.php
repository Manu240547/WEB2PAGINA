...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultado->num_rows > 0) {
        ...
        if (password_verify($contraseña, $fila['contraseña'])) {
            ...
            echo "<div class='exito'>Inicio de sesión exitoso. Bienvenido a Productos.</div>";
            echo "<div class='enlace-productos'><a href='../view/productos.php'>Ir a Productos</a></div>"; // Se ajustó la ruta del enlace
        } else {
